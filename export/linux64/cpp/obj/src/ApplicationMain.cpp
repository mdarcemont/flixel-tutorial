...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(19)
		::openfl::Lib_obj::setPackage(HX_CSTRING("HaxeFlixel"),HX_CSTRING("FlixelTut"),HX_CSTRING("com.example.myapp"),HX_CSTRING("0.0.1"));
		...
		HX_STACK_LINE(35)
		::openfl::Lib_obj::create( Dynamic(new _Function_1_1()),(int)640,(int)480,(int)60,(int)0,(int((int((int((int((int((int((int((int((int((int(::openfl::Lib_obj::HARDWARE) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::openfl::Lib_obj::RESIZABLE))) | int((int)0))) | int(::openfl::Lib_obj::VSYNC))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("FlixelTut"),null(),null());
	}
return null();
}
