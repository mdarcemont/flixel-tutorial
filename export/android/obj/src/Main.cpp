...
Void Main_obj::setupGame( ){
{
		...
		HX_STACK_LINE(71)
		_save->bind(HX_CSTRING("flixel-tutorial"));
		HX_STACK_LINE(72)
		if (((_save->data->__Field(HX_CSTRING("volume"),true) != null()))){
			HX_STACK_LINE(74)
			::flixel::FlxG_obj::sound->set_volume(_save->data->__Field(HX_CSTRING("volume"),true));
		}
		HX_STACK_LINE(76)
